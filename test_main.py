...
class TestParseAIResponse(unittest.TestCase):
    ...
    def test_parse_valid_response(self):
        ...
        expected_output = {
            "vision_text": "Through whimsical chaos, a truth shall unwind,\n" \
                         "A journey of self, a curious kind.\n" \
                         "In laughter and lightness, you\'ll find the key,\n" \
                         "To unlock the person you\'re destined to be.",
            "image_url": "https://storage.googleapis.com/sandbox-456821-oracle-visions/visions/ca27a9e3-97f5-49e5-bc84-9137cbc0d90c.png"
        }
